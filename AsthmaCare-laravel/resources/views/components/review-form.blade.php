<div class="w-11/12 md:w-3/4 mx-auto mb-10 bg-white/70 backdrop-blur-lg border border-gray-200 rounded-2xl shadow-xl p-8 animate-fade-in mt-24">

    {{-- ALERT SUKSES --}}
    @if(session('success'))
        <div id="alert-success" 
             class="mx-auto mb-6 w-full bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg shadow text-center animate-fade-in">
