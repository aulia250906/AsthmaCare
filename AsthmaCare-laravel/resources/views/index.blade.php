...
<section id="beranda" class="relative max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between mt-32 md:mt-20 px-8 md:px-12 mb-20 overflow-hidden">
  ...
  <div class="relative z-10 text-left max-w-xl">
    ...
    <div class="flex flex-col sm:flex-row gap-4">
      <a href="/pertanyaan"class="bg-gradient-to-r from-[#00bcd4] to-[#7fdbff] text-white font-semibold px-8 py-4 rounded-xl shadow-lg hover:from-[#0097a7] hover:to-[#55c6ff] hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">Mulai Tes Sekarang</a>
...
<section class="bg-white py-20 overflow-hidden">
  <div class="max-w-7xl mx-auto px-8 md:px-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 transition-all duration-300 text-center" data-aos="fade-right">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 transition-all duration-300 text-center" data-aos="fade-down-right">
        <div class="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 transition-transform duration-300">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 transition-all duration-300 text-center" data-aos="fade-down-left">
        <div class="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 transition-transform duration-300">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 transition-all duration-300 text-center" data-aos="fade-left">
        <div class="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 transition-transform duration-300">
