<!-- Card Risiko Rendah -->
<div class="max-w-xl mx-auto bg-green-50 rounded-lg shadow-md overflow-hidden border mb-8">
    <!-- Header -->
    <div class="bg-green-100 px-4 py-3 flex items-center gap-2">
...
<!-- Card Risiko Sedang -->
<div class="max-w-xl mx-auto bg-yellow-50 rounded-lg shadow-md overflow-hidden border mb-8">
    <!-- Header -->
    <div class="bg-yellow-100 px-4 py-3 flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
        </svg>
        <h2 class="text-yellow-700 font-bold text-lg">
...
<!-- Card Risiko Tinggi -->
<div class="max-w-xl mx-auto bg-red-50 rounded-lg shadow-md overflow-hidden border mb-8">
    <!-- Header -->
    <div class="bg-red-100 px-4 py-3 flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
        </svg>
        <h2 class="text-red-700 font-bold text-lg">
