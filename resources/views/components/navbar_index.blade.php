<nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
  ...
  <div id="mobile-menu"
    ...
    <ul class="flex flex-col items-center text-center space-y-3 p-4 font-medium">
      <li><a href="#beranda" class="block py-2 px-3 text-gray-900 hover:text-blue-700 transition">Fitur</a></li>
      <li><a href="#fitur" class="block py-2 px-3 text-gray-900 hover:text-blue-700 transition">Artikel</a></li>
      <li><a href="/artikel" class="block py-2 px-3 text-gray-900 hover:text-blue-700 transition">Kontak</a></li>
      <li><a href="#kontak" class="block py-2 px-3 text-gray-900 hover:text-blue-700 transition">Beranda</a></li>
    </ul>

    <!-- Tombol Daftar & Masuk (mobile tetap besar & kanan) -->
