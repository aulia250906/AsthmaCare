...
<section class="bg-white py-20 overflow-hidden">
  <div class="max-w-7xl mx-auto px-8 md:px-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 text-center" data-aos="fade-right">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 text-center" data-aos="fade-down-right">
        <div class="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 text-center" data-aos="fade-down-left">
        <div class="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      <div class="group bg-gradient-to-br from-[#F3FDFF] to-[#E0F7FF] rounded-2xl shadow-md p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 text-center" data-aos="fade-left">
        <div class="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
